...
FIELD_DEFINITIONS = (
    ...
    _f("start_date", "Start Date", "تاريخ البداية", "Start date", ("بداية المشروع", "متى بدأ", "start date"), dtype="date"),
    ...
    _f("effective_end_date", "Amended End Date CR / End Date", "تاريخ الانتهاء", "Effective end date", ("النهاية", "end date", "completion date"), ("متى ينتهي", "متى يخلص", "ومتى ينتهي"), dtype="date", calculated=True, default=True),
    _f("days_remaining", "Effective End Date", "الأيام المتبقية", "Days remaining", ("كم باقي عليه", "remaining days"), ("وش باقي عليه",), dtype="days", calculated=True),
